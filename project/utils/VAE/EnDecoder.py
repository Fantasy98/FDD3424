...
###########################################
# A fixed Encoder for vanilla AutoEncoder, which has one linear layer for compressing to the data
###########################################
class fix_encoder(nn.Module):
    def __init__(self,
                    zdim,
                    knsize,
                    filters     = [1,16,32,64,128,256],
                    ...
                    act_linear   = "elu") -> None:
        """
        Module of encoder architecture used for vanilla AutoEncoder 
